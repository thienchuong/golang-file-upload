...
func (c *fileUploadServiceClient) DownloadFile(ctx context.Context, in *DownloadFileRequest, opts ...grpc.CallOption) (FileUploadService_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileUploadService_ServiceDesc.Streams[0], "/streaming.FileUploadService/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fileUploadServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (FileUploadService_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileUploadService_ServiceDesc.Streams[1], "/streaming.FileUploadService/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
